    ...
    <div class="row">
        @if (Auth::user()->can('employee-salary.list'))
            <div class="col-md-12 grid-margin stretch-card d-flex justify-content-end">
                <div class="">
                    <h4 class="text-right"><a href="{{ route('employee.salary.view') }}" class="btn btn-info">View Salary
                            History</a></h4>
                </div>
            </div>
        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-valid-groups">
                                <div class="mb-3" id="flatpickr-date">
                                    ...
                                    <input type="text" name="date" class="form-control start-date" placeholder="Date"
                                        data-input>
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-6">
                    ...
                    $.ajax({
                        ...
                        success: function(employee) {
                            ...
                            if (employee.data !== null) {
                                $('#employeeSalary').text("Due: ৳ " + (employee.data.credit -
                                    employee.data.debit));
                                if (employee.data.credit != employee.data.debit) {
                                    $('#advancedSalary').text("Note: Avanced Amount: ৳ " +
                                        employee.data.debit);
                                }
                            } else {
                                $('#employeeSalary').text("*");
